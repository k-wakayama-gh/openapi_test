...
# WARNING: Ensure imports from `openapi_test` comes after this line
from openapi_test import app, settings, db  # noqa
from openapi_test.cli import create_user, cli  # noqa
