...
description = """
openapi_test API helps you do awesome stuff. 🚀
"""
...
app = FastAPI(
    ...
    terms_of_service="http://openapi_test.com/terms/",
    contact={
        "name": "k-wakayama-gh",
        "url": "http://openapi_test.com/contact/",
        "email": "k-wakayama-gh@openapi_test.com",
    },
    license_info={
        "name": "The Unlicense",
