...
- 🎯 Entry points to execute your program using `python -m <openapi_test>` or `$ openapi_test` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/k-wakayama-gh/openapi_test/branch/main/graph/badge.svg?token=openapi_test_token_here)](https://codecov.io/gh/k-wakayama-gh/openapi_test)
[![CI](https://github.com/k-wakayama-gh/openapi_test/actions/workflows/main.yml/badge.svg)](https://github.com/k-wakayama-gh/openapi_test/actions/workflows/main.yml)

Awesome openapi_test created by k-wakayama-gh

## Install

from source
```bash
git clone https://github.com/k-wakayama-gh/openapi_test openapi_test
cd openapi_test
make install
```
...
```bash
pip install openapi_test
```

## Executing

```bash
$ openapi_test run --port 8080
```

or

```bash
python -m openapi_test run --port 8080
```

or

```bash
$ uvicorn openapi_test:app
```
...
```bash
❯ openapi_test --help
Usage: openapi_test [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ openapi_test create-user --help
Usage: openapi_test create-user [OPTIONS] USERNAME PASSWORD
...
```bash
openapi_test create-user admin admin --superuser
```
...
Run with `openapi_test run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `openapi_test create-user`.
...
-----------------------------------------------------
openapi_test/__init__.py              4      0   100%
openapi_test/app.py                  16      1    94%
openapi_test/cli.py                  21      0   100%
openapi_test/config.py                5      0   100%
openapi_test/db.py                   10      0   100%
openapi_test/models/__init__.py       0      0   100%
openapi_test/models/content.py       47      1    98%
openapi_test/routes/__init__.py      11      0   100%
openapi_test/routes/content.py       52     25    52%
openapi_test/routes/security.py      15      1    93%
openapi_test/routes/user.py          52     26    50%
openapi_test/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in openapi_test/default.toml.
